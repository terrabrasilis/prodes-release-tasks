...
"""
SELECT ST_XMin(geom) ||','|| ST_YMin(geom) ||','|| ST_XMax(geom) ||','|| ST_YMax(geom) FROM lm_bioma_250 WHERE bioma='Pantanal'
"""
# docker run -it --rm -v /home/andre/Projects/workspace-terrabrasilis2.0/prodes-release-tasks/build-base-raster/files:/files osgeo/gdal:ubuntu-small-3.6.3 bash
# ogrinfo /files/lm_bioma_250.gpkg -sql "SELECT geom FROM lm_bioma_250 WHERE bioma='Pantanal'"
